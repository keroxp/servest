...
export default () => (
  <Content>
    <Article>
      ...
      <p>
        Unfortunately, there are several bug and TBD features and undesirable
      ...
      <p>
        ...
        module. "Being standard" must be tough situation and many people request
        it be stable and unchanged. In that situation, some experimental but
        maybe innovative features are omitted. So I'd wanted to make the handy
        and less opinionated next generation http module in one day.
      </p>
      </section>
      ...
      <p>
        ...
        <ul>
          <li>
            <b>Progressive</b>: It follows the RFC standard and implements essential features for web development.
          </li>
          <li>
