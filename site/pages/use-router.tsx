    ...
    <Content>
      <Article>
        <section id={"router-api"}>
          <h2>Use router</h2>
          <p><Q>Router</Q> is a set of routes and handlers. <Q>App</Q> is also Router.</p>
          <p>There are two difference between App and Router</p>
          <ul>
            <li>App never throws error while processing request.
          ...
          <p>Router is used to by passing to <Q>router.route()</Q>.
          Different from <Q>router.handle()</Q> <Q>route()</Q> accept only string prefix for matching prefix of route.
          </p> 
          <Code
